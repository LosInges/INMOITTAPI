...
const postInmobiliaria = (req, res) => {
    const queries = [
        {
            query: "INSERT INTO inmobiliarias (correo, estados, nombre, direccion, password, notarios, agentes) values (?,?,?,?,?,?,?)",
            params: [req.body.correo, req.body.estados, req.body.nombre, req.body.direccion, req.body.password, req.body.notarios, req.body.agentes]
        },
        {
...
const agregarServicio = (req, res)=>{
    const query = "INSERT INTO servicio(nombre) VALUES (?)";
...
module.exports = { postInmobiliaria, postInmueble, agregarServicio}